export const environment = {
  ...
  firebaseFunctionsUrl: 'https://us-central1-afriziaprod.cloudfunctions.net',
  stripe: {
    publishableKey: 'pk_test_51RFlBDR6xIfUelelzRLmbTd4FPwmLQJGogLyrUFIy2nNklnIlzdzHtLzfwk8IC20XyuDWJgHPcer8lJAQXzMz9bc00lLk2qwZm',
  },
  cinetpay: {
    apiKey: 'your-api-key',
    siteId: 'your-site-id'
