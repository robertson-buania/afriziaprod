import { TuiChartDirective } from '@/app/core/directive/tuiChart.directive'
import { AfterViewInit, Component, ElementRef, ViewChild } from '@angular/core'

@Component({
    selector: 'app-toast-ui',
    imports: [TuiChartDirective],
  ...
  ngOnInit(): void {
    ...
    this.bubbleChart = {
      ...
      options: {
        ...
        tooltip: {
          template: function (category: string, items: any) {
            return (
    ...
    this.heatMapChart = {
      data: {
        ...
        series: [
          ...
          [
            22.1, 22.0, 20.9, 18.3, 15.2, 12.8, 11.8, 13.0, 15.2, 17.6, 19.4,
            21.2,
          ],
          [
