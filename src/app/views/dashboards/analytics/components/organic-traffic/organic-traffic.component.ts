...
@Component({
    selector: 'analytics-organic-traffic',
    imports: [WorldVectorMapComponent, CardTitleComponent],
    templateUrl: './organic-traffic.component.html',
    styles: ``
})
export class OrganicTrafficComponent {
  worldMapConfig = {
    map: 'world',
    selector: '#map_2',
    mapBgColor: '#F7F8F9',
